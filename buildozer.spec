...
requirements = python3,kivy,https://github.com/kivymd/KivyMD/archive/master.zip,asynckivy,materialyoucolor,
    exceptiongroup,asyncgui,sjfirebase,openssl,sjgeminifvai
...
android.presplash_color = #F8FBF1
